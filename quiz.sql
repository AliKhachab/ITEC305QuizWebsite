...
VALUES
    ...
    (16, 'What trainer has a Garchomp?',2),
...
-- INSERT ANSWERS
INSERT INTO answers (id, text, question_id, is_correct)
VALUES
    -- First chunk here is from the capitals quiz
    (1, 'Mexico City', 1, 1), (2, 'Guadalajara', 1, 0), (3,'Tijuana', 1, 0),
    (4, 'Beirut', 2, 1), (5, 'Tripoli', 2, 0), (6, 'Sidon', 2, 0),
    (7, 'Cairo', 3, 1), (8, 'Alexandria', 3, 0), (9, 'Giza', 3, 0),
    (10, 'Bogota', 4, 1), (11, 'Medellin', 4, 0), (12, 'Cali', 4, 0),
    (13, 'Guatemala City', 5, 1), (14, 'Quetzaltenango', 5, 0), (15, 'Escuintla', 5, 0),
    ...
    (37, 'Antalya', 13, 1), (38, 'Istanbul', 13, 0), (39, 'Izmir', 13, 0),
    (40, 'Seoul', 14, 1), (41, 'Busan', 14, 0), (42, 'Incheon', 14, 0),
    (43, 'Ottawa', 15, 1), (44, 'Toronto', 15, 0), (45, 'Montreal', 15, 0),

    -- Second chunk here is from the Pokemon quiz
    (46, 'Cynthia', 16,1), (47, 'Blue', 16, 0), (48, 'Falkner', 16,0),
    (49, 'Hoenn', 17, 1), (50, 'Johto', 17, 0), (51, 'Sinnoh', 17, 0),
    (52,'Pokemon Diamond and Pearl', 18, 1), (53,'Pokemon Crystal', 18, 0), (54, 'Pokemon Black and White 2', 18, 0),
    (55,'Eelektross', 19, 1), (56,'Reshriam', 19, 0), (57, 'Kyurem', 19, 0),
    (58, 'Kanto/Johto', 20, 1), (59, 'Kanto/Hoenn', 20, 0), (60, 'Johto/Hoenn', 20, 0),
    (61, 'Rhydon', 21, 1), (62, 'Pikachu', 21, 0), (63, 'Mewtwo', 21, 0),
    (64, 'Nintendo', 22, 1), (65, 'Square Enix', 22, 0), (66, 'Sega', 22,0),
    (67, 'Base Set', 23, 1), (68, 'Jungle', 23, 0), (69, 'Fossil', 23, 0),
    (70, 'Dragonite', 24, 1), (71, 'Charizard', 24, 0), (72, 'Salamance', 24, 0),
    (73, 'Fairy', 25, 1), (74, 'Air', 25,0), (75, 'Dark', 25, 0),
    (76, 'Dragon', 26, 1), (77, 'Ground', 26, 0), (78, 'Fire', 26, 0),
    (79, 'Dragon', 27,1), (80, 'Fire', 27, 0), (81, 'Dark', 27,0),
